    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Parameter</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="menu.php?menu=parameter"><i class="fa fa-circle-o"></i> Parameter</a></li>  
            <li><a href="menu.php?menu=testimoni"><i class="fa fa-circle-o"></i> Testimoni</a></li>
            <li><a href="menu.php?menu=team"><i class="fa fa-circle-o"></i> Team</a></li>
            <li><a href="menu.php?menu=paket"><i class="fa fa-circle-o"></i> Paket</a></li>
          </ul>
        </li>
        <li class="active treeview menu-open">
          <a href="#">
