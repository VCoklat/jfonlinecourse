...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>Member</b></span>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="menu.php?menu=material">
            <i class="fa fa-book"></i> <span>Material</span>
          </a>
        </li>
        
        <li>
          <a href="menu.php?menu=exercise">
            <i class="fa fa-pencil-square-o"></i> <span>Exercise</span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="menu.php?menu=schedule">
            <i class="fa fa-calendar-check-o"></i> <span>Schedule</span>
          </a>
        </li>
        <li>
          <a href="menu.php?menu=certificate">
            <i class="fa fa-graduation-cap "></i> <span>Certificate</span>
          </a>
        </li>
        <li>
