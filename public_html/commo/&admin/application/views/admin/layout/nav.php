...
<ul class="nav" id="main-menu">
    ...
    <!-- Produk -->           
   <li><a href="#"><i class="fa fa-book"></i> Klien<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/produk')?>">Data Klien</a></li>
            <li><a href="<?php echo base_url('admin/produk/tambah')?>">Tambah Klien</a></li>
   ...
   <li><a href="#"><i class="fa fa-newspaper-o"></i> Berita<span class="fa arrow"></span></a>
    ...
    <!-- Modul Video -->
    <li><a href="#"><i class="fa fa-film"></i> Portfolio<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/portfolio')?>">Data Portfolio</a></li>
            <li><a href="<?php echo base_url('admin/portfolio/tambah')?>">Tambah Portfolio</a></li>
        </ul>
    </li> 
