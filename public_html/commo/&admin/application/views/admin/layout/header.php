...
<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header" >
                ...
                <a class="navbar-brand" style="color:black" href="<?php echo base_url('admin/dasbor') ?>"><?php echo $site['namaweb'] ?></a> 
            </div>
...
<a href="http://commo.jfonlinecourse.com/" class="btn btn-danger square-btn-adjust" target="_blank"><i class="fa fa-home"></i> Homepage</a> 
