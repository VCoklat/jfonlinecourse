...
// Form
echo form_open_multipart('admin/portfolio/tambah');
?>
<div class="col-md-8">
<div class="form-group form-group-lg">
<label>Nama portfolio</label>
<input type="text" name="nama_portfolio" placeholder="Nama portfolio" value="<?php echo set_value('nama_portfolio') ?>" required class="form-control">
</div>
</div>
...
<input type="text" name="keterangan" placeholder="Http://google.com" class="form-control">
</div>
