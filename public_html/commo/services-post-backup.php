    ...
    <section id="project">
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="img/mockup.jpg" class="headline" alt="">
                </div>
                <div class="col-md-6">
                    <h3 class="font-weight-bold">Brochure</h3>
                ...
                <div class="col-12 my-3">
                    <img src="img/portfolio/web1.jpg" class="headline" alt="">
                </div>
                ...
                <div class="row justify-content-center py-2">
                  ...
                  <div class="row">
                    <div class="col-md-6 p-3">
                        <img src="img/brosur.jpg" class="headline " alt="">
                    </div>
                    <div class="col-md-6 p-3">
                        <img src="img/brosur.jpg" class="headline " alt="">
                    </div>
            ...
            <div class="container pt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="img/portfolio/app1.jpg" class="headline" alt="">
                        <h5 class="pb-0 mb-0 pt-3">Design App</h5>
                        <p class="pt-0 mt-0">Mobile Project</p>
                    </div>
                    <div class="col-md-4 text-center">
                        <img src="img/portfolio/card1.jpg" class="headline" alt="">
                        <h5 class="pb-0 mb-0 pt-3">Design App</h5>
                        <p class="pt-0 mt-0">Mobile Project</p>
                    </div>
                    <div class="col-md-4 text-center">
